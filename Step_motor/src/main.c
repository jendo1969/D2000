...
//#define MIN_PERIOD	(USEC_PER_SEC / 800) // 1250us 30rpm
//#define MIN_PERIOD	(USEC_PER_SEC / 1600) // 625us 60rpm
//#define MIN_PERIOD	(USEC_PER_SEC / 3200) // 312.5us 120rpm
#define MIN_PERIOD	(USEC_PER_SEC / 6400) // 156.25us 240rpm
